...
console.log('city distances')
console.log(cityMatrix)
console.log('minimum distance to any other city from each city')
console.log(mins)
console.log('all data for all cities')
console.log(cityData)
// console.log(`var cities = ${JSON.stringify(cityData)}`)
